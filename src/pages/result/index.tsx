...
import getResultImages, { ResultType } from 'src/utils/getResultImages';
...
const ResultPage = () => {
  ...
  const [resultImage, setResultImage] = useState<ResultType>({
    background: '',
    imgT: '',
    imgB: '',
  });
  ...
  const handleExportPNG = () => {
    ...
    // });
    console.log("TODO: make to export what component's image");
  };

  const handleRestart = () => {
    router.replace(process.env.REACT_APP_SERVICE_URL);
  };
